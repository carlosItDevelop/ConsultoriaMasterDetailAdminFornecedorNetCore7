# SmartAdmin for ASP.NET Core 7.0
...
1. Download and install the **ASP.NET Core 7.0 SDK** here: https://dotnet.microsoft.com/download/dotnet-core/thank-you/sdk-3.1.102-windows-x64-installer
